package com.bagri.MemberVeiw.Service;
...
import com.bagri.MemberVeiw.Model.UserModel;
...
public class CartService {
	...
	public String manageCartLine(int cartLineId, int count) {
		...
		int oldTotal = cartLine.getBookCount();
		...
		cart.setTotal(cart.getTotal() - oldTotal + cartLine.getBookCount());
